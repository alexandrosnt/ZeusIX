<script lang="ts">
	...
	let { serverName, onclose, onconfirm }: Props = $props();
...
<div class="overlay" class:visible onclick={handleOverlayClick} onkeydown={handleKeydown} role="presentation">
	<div class="modal" class:visible role="alertdialog" aria-modal="true" aria-labelledby="delete-modal-title" aria-describedby="delete-modal-desc">
		<!-- Icon -->
		<div class="header">
		...
		<!-- Warning -->
		<p id="delete-modal-desc" class="warning">
